...
/**
 * Classe responsável por converter automaticamente 
 * um Enum presente em um formulário com as informações
 * recebidas pelo front-end <br>
 * O Enum deverá implementar a interface {@link ValorEnum}
 * para que seja possível realizar a conversão
 * 
